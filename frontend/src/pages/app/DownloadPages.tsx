...
const platformLabel = (platform: ClientPlatform) =>
  platform === "macos" ? "macOS" : platform === "windows" ? "Windows" : "Android";
          ...
          <div className="workspace-card-soft">
            <div className="card-body flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">下载完成后，可按教程完成 SPA 或 BFF 部署。</p>
              </div>
              <Link to="/app/deploy-guide" className="landing-button-secondary rounded-lg px-5 py-3 text-base">
                查看部署教程
              </Link>
            </div>
          </div>
